...
# =========================================================
# =========================================================
# DATABASE (SAFE VIA STREAMLIT SECRETS)
# =========================================================
try:
    # Probeert eerst Render Environment Variables, daarna Streamlit Secrets
    ...
    DB_PORT = int(os.getenv("DB_PORT") or st.secrets["DB_PORT"])
except Exception:
    DB_HOST = ""
    DB_NAME = ""
    DB_USER = ""
